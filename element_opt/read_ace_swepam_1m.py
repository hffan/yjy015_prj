#--coding:utf-8--
# date:     2019-08-14
# function: read 1-minute averaged Real-time Bulk Parameters of the Solar Wind Plasma 
...
def read_data(fullpath):
    ...
    for line in fh.readlines()[linesOfHeader:]:
        ...
        # data[timeStamp]={
            ...
            # 'Temp':    Temp,
            # 'website':'SWPC',
            # 'category_abbr_en': 'SWPC_ace_sw1m',}
...
def plot_data(data):
    ...
    plt.title('1-minute averaged Real-time Bulk Parameters of the Solar Wind Plasma',fontdict=font)
    plt.grid()
    ...
    plt.savefig('ace_swepam.png')
    plt.show()		

if __name__ == '__main__':
    # 1，获取文件全路径
    cwd = os.getcwd()
    filename='20190806_ace_swepam_1m.txt'
