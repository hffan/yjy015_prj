...
class Pyserial:
    def __init__(self):
        ...
        if 'Linux' == platform.system():
            print ('Linux')
            self.ser = serial.Serial(port='/dev/ttyUSB0', baudrate = 9600, bytesize = 8,parity = 'N',stopbits = 1,timeout=1)
...
if __name__ == "__main__":
    ...
    crc = ps.crc16( x=[0x01,0x06,0x00,0x11,0x00,0x01], invert = 'False')
    print ('调整音量1级 crc = ',crc)
    ...
    cmd3 = [0x01,0x06,0x00,0x11,0x00,0x01,0x18,0x0F]                # 调整音量1级
